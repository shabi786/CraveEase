...
const Body = () => {
    ...
    async function getRestaurants() {
        ...
        setAllRestaurants(res?.data?.cards[2]?.card?.card?.gridElements?.infoWithStyle?.restaurants);
    ...
    return (
        <div className=" flex flex-col my-24">
            <div className="flex justify-center mb-4">
                ...
                />
                <button className="bg-orange-600 w-1/12 rounded-md  text-white hover:bg-orange-800"
                    onClick={() => {
